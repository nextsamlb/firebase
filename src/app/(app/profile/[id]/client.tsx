              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card className="glass border-primary/20">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-white/70">{t('matches')}:</span>
                      <span className="text-white font-bold">{player.stats.played}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/70">{t('goals')}:</span>
                      <span className="text-white font-bold">{player.stats.goalsFor}</span>
                    </div>
                     <div className="flex justify-between">
                      <span className="text-white/70">{t('points')}:</span>
                      <span className="text-white font-bold">{player.stats.points}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <Card className="glass border-primary/20">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="text-white/70">{t('goalDifference')}:</span>
                      <span className="text-white font-bold">{player.stats.goalDifference}</span>
                    </div>
                     <div className="flex justify-between">
