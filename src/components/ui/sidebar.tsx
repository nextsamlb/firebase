...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("group peer hidden md:flex text-sidebar-foreground", className)}
        data-state={state}
        ...
        <div
          className={cn(
            ...
            "group-data-[collapsible=offcanvas]:w-0",
             "w-[--sidebar-width-icon]", // Collapsed width
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)] group-data-[state=expanded]:w-[--sidebar-width]"
